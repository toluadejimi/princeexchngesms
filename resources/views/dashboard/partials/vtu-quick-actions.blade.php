<div class="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-sm p-4 sm:p-5">
    ...
    <div class="relative grid grid-cols-2 md:grid-cols-4 gap-3">
        <a href="{{ route('vtu.index', ['type' => 'airtime']) }}" class="group relative overflow-hidden min-h-[132px] rounded-2xl border border-slate-200 dark:border-slate-700 bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-yellow-950/20 dark:to-orange-950/10 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-yellow-500/10 p-4 transition">
            <span class="absolute -right-6 -top-6 w-20 h-20 rounded-full bg-yellow-400/20"></span>
            <span class="relative w-11 h-11 rounded-2xl bg-gradient-to-br from-yellow-400 to-orange-500 text-white flex items-center justify-center shadow-sm mb-4">
        ...
        <a href="{{ route('vtu.index', ['type' => 'data']) }}" class="group relative overflow-hidden min-h-[132px] rounded-2xl border border-mint-200 dark:border-mint-800 bg-gradient-to-br from-mint-50 to-cyan-50 dark:from-mint-950/25 dark:to-cyan-950/10 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-mint-500/10 p-4 transition">
            <span class="absolute -right-6 -top-6 w-20 h-20 rounded-full bg-mint-400/20"></span>
            <span class="relative w-11 h-11 rounded-2xl bg-gradient-to-br from-blue-500 to-cyan-500 text-white flex items-center justify-center shadow-sm mb-4">
        ...
        <a href="{{ route('vtu.index', ['type' => 'electricity']) }}" class="group relative overflow-hidden min-h-[132px] rounded-2xl border border-slate-200 dark:border-slate-700 bg-gradient-to-br from-amber-50 to-red-50 dark:from-amber-950/20 dark:to-red-950/10 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-amber-500/10 p-4 transition">
            <span class="absolute -right-6 -top-6 w-20 h-20 rounded-full bg-amber-400/20"></span>
            <span class="relative w-11 h-11 rounded-2xl bg-gradient-to-br from-amber-500 to-red-500 text-white flex items-center justify-center shadow-sm mb-4">
        ...
        <a href="{{ route('vtu.index', ['type' => 'cable']) }}" class="group relative overflow-hidden min-h-[132px] rounded-2xl border border-slate-200 dark:border-slate-700 bg-gradient-to-br from-violet-50 to-indigo-50 dark:from-violet-950/20 dark:to-indigo-950/10 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-violet-500/10 p-4 transition">
            <span class="absolute -right-6 -top-6 w-20 h-20 rounded-full bg-violet-400/20"></span>
            <span class="relative w-11 h-11 rounded-2xl bg-gradient-to-br from-violet-500 to-indigo-600 text-white flex items-center justify-center shadow-sm mb-4">
