...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/fund-now', [FundWalletController::class, 'fundNow'])->name('fund-wallet.fund-now')->middleware('throttle:10,1');
    Route::post('/fund-manual-submit', [FundWalletController::class, 'fundManualSubmit'])->name('fund-wallet.manual-submit')->middleware('throttle:5,1');
});
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/rent', [RentalController::class, 'store'])->name('rentals.store')->middleware('throttle:10,1');
    ...
    Route::get('/api/services', [RentalController::class, 'services'])->name('rentals.services')->middleware('throttle:30,1');
    Route::get('/api/countries', [RentalController::class, 'countries'])->name('rentals.countries')->middleware('throttle:30,1');
