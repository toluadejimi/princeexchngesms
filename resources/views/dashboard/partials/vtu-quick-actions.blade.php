<div class="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-sm px-3 py-3 sm:px-4 sm:py-3" x-data="{}">
    <style>
        .dark .vtu-shortcut-card {
            background: rgba(30, 41, 59, 0.72) !important;
            border-color: rgba(51, 65, 85, 1) !important;
        }
        .dark .vtu-shortcut-title {
            color: #f8fafc !important;
        }
        .dark .vtu-shortcut-subtitle {
    ...
    <div class="relative grid gap-2" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));">
        <a href="{{ route('vtu.index', ['type' => 'airtime']) }}" class="vtu-shortcut-card group relative overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/70 hover:-translate-y-0.5 hover:shadow-md transition" style="min-height:64px;display:flex;align-items:center;gap:10px;padding:10px 12px;">
            ...
            <span class="relative min-w-0">
                <span class="vtu-shortcut-title block text-sm font-bold text-slate-900 dark:text-slate-100">Airtime</span>
                <span class="vtu-shortcut-subtitle block text-xs text-slate-500 dark:text-slate-300 truncate">Top up any network</span>
            </span>
        </a>
        <a href="{{ route('vtu.index', ['type' => 'data']) }}" class="vtu-shortcut-card group relative overflow-hidden rounded-2xl border border-mint-200 dark:border-mint-800 bg-mint-50/60 dark:bg-slate-800/70 hover:-translate-y-0.5 hover:shadow-md transition" style="min-height:64px;display:flex;align-items:center;gap:10px;padding:10px 12px;">
            ...
            <span class="relative min-w-0">
                <span class="vtu-shortcut-title block text-sm font-bold text-slate-900 dark:text-slate-100">Data</span>
                <span class="vtu-shortcut-subtitle block text-xs text-slate-500 dark:text-slate-300 truncate">Daily to yearly plans</span>
            </span>
        </a>
        <a href="{{ route('vtu.index', ['type' => 'electricity']) }}" class="vtu-shortcut-card group relative overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/70 hover:-translate-y-0.5 hover:shadow-md transition" style="min-height:64px;display:flex;align-items:center;gap:10px;padding:10px 12px;">
            ...
            <span class="relative min-w-0">
                <span class="vtu-shortcut-title block text-sm font-bold text-slate-900 dark:text-slate-100">Electricity</span>
                <span class="vtu-shortcut-subtitle block text-xs text-slate-500 dark:text-slate-300 truncate">Buy meter tokens</span>
            </span>
        </a>
        <a href="{{ route('vtu.index', ['type' => 'cable']) }}" class="vtu-shortcut-card group relative overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/70 hover:-translate-y-0.5 hover:shadow-md transition" style="min-height:64px;display:flex;align-items:center;gap:10px;padding:10px 12px;">
            ...
            <span class="relative min-w-0">
                <span class="vtu-shortcut-title block text-sm font-bold text-slate-900 dark:text-slate-100">Cable TV</span>
                <span class="vtu-shortcut-subtitle block text-xs text-slate-500 dark:text-slate-300 truncate">Renew TV packages</span>
            </span>
        </a>
    </div>
</div>
